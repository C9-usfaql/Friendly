...
function Home() {
  ...
  return (
    <div className='home-contenter'>
        ...
        <input  style={{width:"100%",height:"100%",borderRadius:"4px", border:"1px solid rgb(200,200,200)",marginTop:"10px"}} placeholder='what Think?' id='content' onChange={(e)=>{
            setContent(e.target.value);
        }} />
        
            <div className='contenter-input-image' style={{textAlign:"left"}}>
                <div className='input-image'><i class="gg-image"></i> <input type="file" id="img" name="img" accept="image/*" onChange={(e)=>{
        ...
        onClick={()=>{
            ...
            if(ImagePost){
                ...
                axios.post("http://localhost:5000/posts/create", {content, author:userId},{
                    headers: {
                        Authorization: `Bearer ${token}`
                    }}).then((result) => {
                    axios.get("http://localhost:5000/posts",config).then((result) => {
        ...
        return(
            <div className='contenter-post'>
                ...
                <div>
                    {post.image && <div style={{ position: "relative", width: "100%", height: "100%" }}>
      {loading && (
        <div
          style={{
            position: "absolute",
        ...
        />
                ...
                <div className='bottom-bar-post'>
                    ...
                    <div className='interact-button' onClick={()=>{
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#4464AD" class="bi bi-hand-thumbs-up-fill" viewBox="0 0 16 16">
