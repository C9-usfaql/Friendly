...
const closeModal = () => {
  ...
  return (
    <div className='contenter-profile-page'>
      ...
      {dataPosts && dataPosts.slice().reverse().map((post, i)=>{
        ...
        />
                ...
                <div className='bottom-bar-post'>
                    ...
                    <div className='interact-button' onClick={()=>{ 
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#4464AD" className="bi bi-hand-thumbs-up-fill" viewBox="0 0 16 16">
                        ...
                        :<svg xmlns={"http://www.w3.org/2000/svg"}  width="24" height="24" fill="#4464AD" className="bi bi-hand-thumbs-up" viewBox="0 0 16 16">
